...
- :bulb: Request features: [Feature Requests](https://github.com/serpapps/upornia-downloader/issues)
...
1. Open the latest release page:
   [https://github.com/serpapps/upornia-downloader/releases/latest](https://github.com/serpapps/upornia-downloader/releases/latest)
